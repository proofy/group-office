 ...
 * @version $Id: ItemsGrid.js 21269 2016-03-22 16:01:21Z mschering $
...
//		}	
	...
	updateTotals : function(){
		...
		var margin = 100-(100*costs/subtotal);
	...
	_roundTotals: function (amount) {
		...
		switch(GO.billing.billingRound) {
			case 'up' : return Math.ceil(amount*100)/100;
			case 'down' : return Math.floor(amount*100)/100;
