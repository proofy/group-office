...
class DropboxClient {
	 ...
	 * 
	 * @access public
	 * @param StringHelper $return_url URL users are redirected after authorization
	 ...
	 * 
	 * @access public
	 * @param StringHelper|object $token The Access Token
	 * @return none
	 */
	 ...
	 * 
	 * @access public
	 * @param StringHelper|object $dropbox_path Dropbox path of the folder
	 ...
	 * 
	 * @access public
	 * @param StringHelper|object $dropbox_file Dropbox path or metadata object of the file to download. 
	 * @param StringHelper $dest_path Local path for destination
	 * @param StringHelper $rev Optional. The revision of the file to retrieve. This defaults to the most recent revision.
