...
$l['connected']='Connection réussie !';
$l['syncNow']='Cliquer ici pour initier la première synchronisation';
$l['syncing']='Synchronisation en cours...';
$l['done']='Synchronisation effectuée. Vous retrouverez le dossier "Dropbox" dans votre modules "fichiers". Vous pouvez fermer cette page. Votre dossier se synchronisera toutes les minutes. Cela pourra prendre plus ou moins de temps suivant la quantité de données à transférer.';

$l['disconnect']="Déconnecter";
$l['disconnectedSuccessfully']="Déconnection réussie !";