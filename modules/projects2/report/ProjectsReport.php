 ...
 * @version $Id: ProjectsReport.php 20801 2015-09-09 14:02:31Z wsmits $ 
...
class ProjectsReport extends AbstractReport {
	...
	public function name() {
		return GO::t('projectsReport', 'projects2');
	}
...
td{font-size:80%}';
		...
		$html .= '<thead>' .
						$this->_pdf->tableHeaders(array(
								...
								new PdfTableColumn(array('width' => 70, 'text' => GO::t('travelDistance','projects2'), 'class'=>'head','align'=>'right')),								
								new PdfTableColumn(array('width' => 70, 'text' => GO::t('travel_costs','projects2'), 'class'=>'head','align'=>'right')),								
								new PdfTableColumn(array('width' => 70, 'text' => GO::t('percentageComplete','projects2'), 'class'=>'head','align'=>'right')),								
...
//								new PdfTableColumn(array('width' => 60, 'text' => GO::t('realization','projects2'), 'class'=>'head','align'=>'right')),
		...
		if (!$stmt->rowCount()) {
			$html .= '<tr>' .
							'<td colspan="1">' . GO::t('strNoItems') . '</td>' .
							'</tr>';
		} else {
