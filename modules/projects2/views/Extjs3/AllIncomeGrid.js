 ...
 *
 * @version $Id: AllIncomeGrid.js 20558 2015-06-01 12:05:56Z mdhart $
...
GO.projects2.AllIncomeGrid = Ext.extend(GO.grid.GridPanel,{
	...
	initComponent : function(){
		...
		this.store = new GO.data.JsonStore({
			...
			fields:['id','project_id', 'project_path', 'description','reference_no', 'amount','is_invoiced','invoiceable','period_start','period_end','invoice_at','invoice_number', 'type','hide_print', 'comments']
		});
