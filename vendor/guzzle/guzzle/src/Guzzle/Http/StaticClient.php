...
final class StaticClient
{
     ...
     *
     * @param StringHelper          $className Class name to use to mount
    ...
    /**
     * @param  StringHelper $method  HTTP request method (GET, POST, HEAD, DELETE, PUT, etc)
     * @param  StringHelper $url     URL of the request
