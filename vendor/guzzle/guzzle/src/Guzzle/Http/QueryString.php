...
class QueryString extends Collection
{
    ...
    /** @var StringHelper The query string field separator (e.g. '&') */
    protected $fieldSeparator = '&';

    /** @var StringHelper The query string value separator (e.g. '=') */
     ...
     *
     * @param StringHelper $query Query string to parse
     *
     * @return self
     */
     ...
     *
     * @param bool|StringHelper $encode Set to TRUE to use RFC 3986 encoding (rawurlencode), false to disable encoding, or
     ...
     *
     * @param StringHelper $separator The query string separator that will separate fields
     *
     * @return self
     */
     ...
     *
     * @param StringHelper $separator The query string separator that will separate values from fields
     *
     * @return self
     */
     ...
     *
     * @param StringHelper $value Value to encode
     *
     * @return StringHelper
     */
     ...
     *
     * @param StringHelper $name  Name of the field
