...
class EntityBody extends Stream implements EntityBodyInterface
{
     ...
     *
     * @param resource|StringHelper|EntityBody $resource Entity body data
     ...
     *
     * @param StringHelper $string String of data
     *
     * @return EntityBody
     */
     ...
     *
     * @return bool|StringHelper Returns an MD5 string on success or FALSE on failure
