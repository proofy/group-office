...
interface RequestFactoryInterface
{
     ...
     *
     * @param StringHelper $message HTTP message as a string
     *
     ...
     *
     * @param StringHelper $method HTTP method (GET, POST, PUT, HEAD, DELETE, etc)
     *
     ...
     * @param StringHelper|resource|array|EntityBodyInterface $body            Body to send in the request
     * @param StringHelper                                    $protocol        Protocol (HTTP, SPYDY, etc)
     * @param StringHelper                                    $protocolVersion 1.0, 1.1, etc
     *
     * @return RequestInterface
     */
     ...
     *
     * @param StringHelper                                    $method  HTTP method (GET, POST, PUT, PATCH, HEAD, DELETE, ...)
     * @param StringHelper|Url                                $url     HTTP URL to connect to
     * @param array|Collection                          $headers HTTP headers
     * @param StringHelper|resource|array|EntityBodyInterface $body    Body to send in the request
