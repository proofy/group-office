...
class Request extends AbstractMessage implements RequestInterface
{
    ...
    /** @var StringHelper HTTP method (GET, PUT, POST, DELETE, HEAD, OPTIONS, TRACE) */
    protected $method;
    ...
    /** @var StringHelper State of the request object */
    protected $state;

    /** @var StringHelper Authentication username */
    protected $username;

    /** @var StringHelper Auth password */
    protected $password;
    ...
    /**
     * @param StringHelper           $method  HTTP method
     * @param StringHelper|Url       $url     HTTP URL to connect to. The URI scheme, host header, and URI are parsed from the
