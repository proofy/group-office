...
interface EntityEnclosingRequestInterface extends RequestInterface
{
     ...
     *
     * @param StringHelper|resource|EntityBodyInterface $body        Body to use in the entity body of the request
     * @param StringHelper                              $contentType Content-Type to set. Leave null to use an existing
     ...
     *
     * @param StringHelper $field Field to retrieve
     *
     * @return mixed|null
     */
     ...
     *
     * @param StringHelper $key   Key to set
     ...
     *
     * @param StringHelper $field Name of the POST field or file to remove
     *
     * @return self
     */
     ...
     *
     * @param StringHelper $fieldName POST fields to retrieve
     *
     ...
     *
     * @param StringHelper $fieldName POST file field name to remove
     *
     * @return self
     */
     ...
     *
     * @param StringHelper $field       POST field to use (e.g. file). Used to reference content from the server.
     * @param StringHelper $filename    Full path to the file. Do not include the @ symbol.
     * @param StringHelper $contentType Optional Content-Type to add to the Content-Disposition.
     *                            Default behavior is to guess. Set to false to not specify.
     * @param StringHelper $postname    The name of the file, when posted. (e.g. rename the file)
     * @return self
     */
