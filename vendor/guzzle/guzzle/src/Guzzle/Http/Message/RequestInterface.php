...
interface RequestInterface extends MessageInterface, HasDispatcherInterface
{
     ...
     *
     * @param StringHelper $url|Url Full URL to set including query string
     *
     * @return self
     */
     ...
     *
     * @param StringHelper $scheme Scheme to set
     *
     * @return self
     */
     ...
     *
     * @param StringHelper $host Host to set (e.g. www.yahoo.com, www.yahoo.com:80)
     *
     * @return self
     */
     ...
     *
     * @param StringHelper|array $path Path to set or array of segments to implode
     *
     * @return self
     */
     ...
     *
     * @param StringHelper|bool $user     User name or false disable authentication
     * @param StringHelper      $password Password
     * @param StringHelper      $scheme   Authentication scheme ('Basic', 'Digest', or a CURLAUTH_* constant (deprecated))
     *
     * @return self
     ...
     *
     * @param StringHelper $protocol HTTP protocol version to use with the request
     *
     * @return self
     */
     ...
     *
     * @param EntityBodyInterface|StringHelper|resource $body Response body object. Pass a string to attempt to store the
     ...
     *
     * @param StringHelper $state   State of the request ('complete', 'transfer', 'new', 'error')
     * @param array  $context Contextual information about the state change
     *
     * @return StringHelper Returns the current state of the request (which may have changed due to events being fired)
     */
     ...
     *
     * @param StringHelper $name Cookie to retrieve
     *
     * @return null|StringHelper
     */
     ...
     *
     * @param StringHelper $name  Name of the cookie to add
     * @param StringHelper $value Value to set
     *
     * @return self
     */
     ...
     *
     * @param StringHelper $name Cookie to remove by name
     *
     * @return self
     */
