...
class PostFile implements PostFileInterface
{
    ...
    /**
     * @param StringHelper $fieldName   Name of the field
     * @param StringHelper $filename    Local path to the file
     * @param StringHelper $postname    Remote post file name
     * @param StringHelper $contentType Content-Type of the upload
     */
