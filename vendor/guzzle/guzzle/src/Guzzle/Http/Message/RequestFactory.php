...
class RequestFactory implements RequestFactoryInterface
{
    ...
    /** @var StringHelper Class to instantiate for requests with no body */
    protected $requestClass = 'Guzzle\\Http\\Message\\Request';

    /** @var StringHelper Class to instantiate for requests with a body */
     ...
     * @param StringHelper           $method  Method to set
     *
