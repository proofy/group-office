...
class Header implements HeaderInterface
{
    ...
    /**
     * @param StringHelper       $header Name of the header
     * @param array|StringHelper $values Values of the header as an array or a scalar
     * @param StringHelper       $glue   Glue used to combine multiple values into a string
     */
