...
class Response extends AbstractMessage implements \Serializable
{
    ...
    /** @var StringHelper The reason phrase of the response (human readable code) */
    protected $reasonPhrase;

    /** @var StringHelper The status code of the response */
    protected $statusCode;

    /** @var array Information about the request */
    protected $info = array();

    /** @var StringHelper The effective URL that returned this response */
     ...
     *
     * @param StringHelper $message Response message
     *
     ...
     *
     * @param StringHelper                              $statusCode The response status code (e.g. 200, 404, etc)
     * @param ToArrayInterface|array              $headers    The response headers
     * @param StringHelper|resource|EntityBodyInterface $body       The body of the response
     *
     ...
     *
     * @return EntityBodyInterface|StringHelper
     */
     ...
     *
     * @param EntityBodyInterface|StringHelper $body Body to set
     *
     * @return self
     */
     ...
     *
     * @param StringHelper $protocol Response protocol
     * @param StringHelper $version  Protocol version
     *
     * @return self
     */
     ...
     *
     * @param StringHelper $key A single statistic to check
     *
     * @return array|StringHelper|null Returns all stats if no key is set, a single stat if a key is set, or null if a key
     ...
     * @param StringHelper $reasonPhrase Response reason phrase
     *
     * @return self
     ...
     *
     * @return StringHelper Returns what partial content range types this server supports.
     */
     ...
     *
     * @return StringHelper|null Returns valid actions for a specified resource. To be used for a 405 Method not allowed.
     */
     ...
     *
     * @param StringHelper $method Method to check
     *
     * @return bool
     */
     ...
     *
     * @return StringHelper|null Returns the language the content is in.
     */
     ...
     *
     * @return StringHelper|null Returns an alternate location for the returned data (e.g /index.htm)
     */
     ...
     *
     * @return StringHelper|null Returns the Content-Disposition header
     */
     ...
     *
     * @return StringHelper|null Returns a Base64-encoded binary MD5 sum of the content of the response.
     */
     ...
     *
     * @return StringHelper Returns where in a full body message this partial message belongs (e.g. bytes 21010-47021/47022).
     */
     ...
     *
     * @return StringHelper Returns the mime type of this content.
     */
     ...
     *
     * @param StringHelper $type Content type to check against
     *
     * @return bool
     */
     ...
     *
     * @return StringHelper|null Returns the date and time that the message was sent.
     */
     ...
     *
     * @return StringHelper|null Returns an identifier for a specific version of a resource, often a Message digest.
     */
     ...
     *
     * @return StringHelper|null Returns the date/time after which the response is considered stale.
     */
     ...
     *
     * @return StringHelper|null Returns the last modified date for the requested object, in RFC 2822 format
     ...
     *
     * @return StringHelper|null Used in redirection, or when a new resource has been created.
     */
     ...
     *
     * @return StringHelper|null Authentication to access the proxy (e.g. Basic)
     */
     ...
     *
     * @return StringHelper|null A name for the server
     */
     ...
     *
     * @return StringHelper|null An HTTP cookie.
     */
     ...
     *
     * @return StringHelper|null The Trailer general field value indicates that the given set of header fields is present in
     ...
     *
     * @return StringHelper|null The form of encoding used to safely transfer the entity to the user
     */
     ...
     *
     * @return StringHelper|null Tells downstream proxies how to match future request headers to decide whether the cached
     ...
     *
     * @return StringHelper|null Informs the client of proxies through which the response was sent.
     */
     ...
     *
     * @return StringHelper|null A general warning about possible problems with the entity body
     */
     ...
     *
     * @return StringHelper|null Indicates the authentication scheme that should be used to access the requested entity
     */
     ...
     *
     * @return array|StringHelper|int|bool|float
     ...
     *
     * @param StringHelper $url The effective URL
     *
     * @return self
     */
