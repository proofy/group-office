...
interface HeaderInterface extends ToArrayInterface, \Countable, \IteratorAggregate
{
     ...
     *
     * @param StringHelper $value Value to add to the header
     *
     * @return self
     */
     ...
     *
     * @param StringHelper $name Name to change to
     *
     * @return self
     */
     ...
     *
     * @param StringHelper $glue Glue used to implode multiple values
     *
     * @return self
     */
     ...
     *
     * @param StringHelper $searchValue Value to search for
     *
     * @return bool
     */
     ...
     *
     * @param StringHelper $searchValue Value to remove
     *
     * @return self
     */
