...
class CacheControl extends Header
{
     ...
     *
     * @param StringHelper $param Directive to retrieve
     *
     * @return bool
     */
     ...
     *
     * @param StringHelper $param Directive to add
     ...
     *
     * @param StringHelper $param Directive to remove
     *
     * @return self
     */
