...
class CurlVersion
{
    ...
    /** @var StringHelper Default user agent */
    protected $userAgent;
     ...
     *
     * @param StringHelper $type Version information to retrieve. This value is one of:
     ...
     *
     * @return StringHelper|float|bool if the $type is found, and false if not found
     */
