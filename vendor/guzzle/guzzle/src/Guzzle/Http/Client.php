...
class Client extends AbstractHasDispatcher implements ClientInterface
{
    ...
    /** @var StringHelper The user agent string to set on each request */
    protected $userAgent;
    ...
    /**
     * @param StringHelper           $baseUrl Base URL of the web service
     ...
     *
     * @param StringHelper $keyOrPath request.options key (e.g. allow_redirects) or path to a nested key (e.g. headers/foo)
     ...
     *
     * @param StringHelper $template  Template to expand
     ...
     *
     * @param StringHelper $pharCacertPath Path to the phar cacert. For example:
     *                               'phar://aws.phar/Guzzle/Http/Resources/cacert.pem'
     *
     * @return StringHelper Returns the path to the extracted cacert file.
