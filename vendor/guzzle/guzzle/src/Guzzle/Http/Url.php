...
class Url
{
     ...
     *
     * @param StringHelper $url Full URL used to create a Url object
     *
     * @return Url
     ...
     *
     * @param StringHelper                   $scheme   Scheme of the URL
     * @param StringHelper                   $host     Host of the URL
     * @param StringHelper                   $username Username of the URL
     * @param StringHelper                   $password Password of the URL
     * @param int                      $port     Port of the URL
     * @param StringHelper                   $path     Path of the URL
     * @param QueryString|array|StringHelper $query    Query string of the URL
     * @param StringHelper                   $fragment Fragment of the URL
     */
     ...
     *
     * @param StringHelper $host Host to set (e.g. www.yahoo.com, yahoo.com)
     *
     * @return Url
     */
     ...
     *
     * @param array|StringHelper $path Path string or array of path segments
     *
     * @return Url
     */
     ...
     *
     * @param StringHelper $relativePath Relative path to add
     *
     * @return Url
     */
     ...
     *
     * @param StringHelper $password Password to set
     *
     * @return Url
     */
     ...
     *
     * @param StringHelper $username Username to set
     *
     * @return Url
     */
     ...
     *
     * @param QueryString|StringHelper|array $query Query to set
     *
     * @return Url
     */
     ...
     *
     * @param StringHelper $fragment Fragment to set
     *
     * @return Url
     */
     ...
     *
     * @param StringHelper $url           Relative URL to combine with
