...
interface ClientInterface extends HasDispatcherInterface
{
     ...
     *
     * @param bool|StringHelper $key Configuration value to retrieve. Set to FALSE to retrieve all values of the client.
     ...
     *
     * @param StringHelper                                    $method  HTTP method. Defaults to GET
     * @param StringHelper|array                              $uri     Resource URI.
     * @param array|Collection                          $headers HTTP headers
     * @param StringHelper|resource|array|EntityBodyInterface $body    Entity body of request (POST/PUT) or response (GET)
     ...
     * @param StringHelper|array                        $uri     Resource URI
     * @param array|Collection                    $headers HTTP headers
     * @param StringHelper|resource|EntityBodyInterface $body    Body to send in the request
     * @param array                               $options Options to apply to the request
     *
     ...
     * @param StringHelper|array                                $uri      Resource URI
     * @param array|Collection                            $headers  HTTP headers
     * @param array|Collection|StringHelper|EntityBodyInterface $postBody POST body. Can be a string, EntityBody, or
     ...
     *
     * @param StringHelper $url The base service endpoint URL of the webservice
     *
     * @return self
     */
     ...
     *
     * @param StringHelper $userAgent      User agent string
     ...
     * it.
     *
     * @param StringHelper|bool $certificateAuthority bool, file path, or directory path
