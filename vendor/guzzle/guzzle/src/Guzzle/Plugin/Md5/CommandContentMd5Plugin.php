...
{
    /** @var StringHelper Parameter used to check if the ContentMD5 value is being added */
    protected $contentMd5Param;

    /** @var StringHelper Parameter used to check if validation should occur on the response */
    protected $validateMd5Param;

    /**
     * @param StringHelper $contentMd5Param  Parameter used to check if the ContentMD5 value is being added
     * @param StringHelper $validateMd5Param Parameter used to check if validation should occur on the response
     */
