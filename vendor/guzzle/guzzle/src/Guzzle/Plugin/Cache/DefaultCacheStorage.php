...
class DefaultCacheStorage implements CacheStorageInterface
{
     ...
     * @param StringHelper $keyPrefix  Provide an optional key prefix to prefix on all cache keys
     ...
     *
     * @param StringHelper              $url  URL of the entry
     ...
     *
     * @param StringHelper $vary Response vary header
