...
interface CookieJarInterface extends \Countable, \IteratorAggregate
{
     ...
     *
     * @param StringHelper $domain Set to clear only cookies matching a domain
     * @param StringHelper $path   Set to clear only cookies matching a domain and path
     * @param StringHelper $name   Set to clear only cookies matching a domain, path, and name
     *
     ...
     *
     * @param StringHelper $domain          Domain of the cookie
     * @param StringHelper $path            Path of the cookie
     * @param StringHelper $name            Name of the cookie
