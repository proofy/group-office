...
class Cookie implements ToArrayInterface
{
    ...
    /**
     * @var StringHelper ASCII codes not valid for for use in a cookie name
     *
     ...
     * Set the cookie name
     *
     * @param StringHelper $name Cookie name
     *
     * @return Cookie
     */
     ...
     *
     * @param StringHelper $value Cookie value
     *
     * @return Cookie
     */
     ...
     *
     * @param StringHelper $path Path of the cookie
     *
     * @return Cookie
     */
     ...
     *
     * @param StringHelper|int $version Version to set
     *
     * @return Cookie
     */
     ...
     *
     * @param StringHelper $comment Cookie comment
     *
     * @return Cookie
     */
     ...
     *
     * @param StringHelper $commentUrl Cookie comment URL for more information
     *
     * @return Cookie
     */
     ...
     *
     * @param StringHelper $name Name of the data point to retrieve
     *
     ...
     *
     * @param StringHelper $name  Name of the attribute to set
     ...
     *
     * @param StringHelper $path Path to check against
     *
     * @return bool
     */
     ...
     *
     * @param StringHelper $domain Domain to check against
     *
     * @return bool
     */
     ...
     *
     * @return bool|StringHelper Returns true if valid or an error message if invalid
     */
