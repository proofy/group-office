...
class Parameter
{
     ...
     *
     * @param StringHelper $value Value that is currently set
     *
     ...
     *
     * @param StringHelper $name Name to set
     *
     * @return self
     */
     ...
     *
     * @param StringHelper|array $type Type of parameter or array of simple types used in a union
     *
     * @return self
     */
     ...
     *
     * @param StringHelper|null $default Default value to set
     *
     * @return self
     */
     ...
     *
     * @param StringHelper $description Description
     *
     * @return self
     */
     ...
     *
     * @param StringHelper|null $location Location of the parameter
     *
     * @return self
     */
     ...
     *
     * @param StringHelper|null $name Name of the value as it is sent over the wire
     *
     * @return self
     */
     ...
     *
     * @param StringHelper|null $name Specify a particular property name to retrieve
     *
     ...
     *
     * @param StringHelper|array|null $nameOrData The name of a specific extra to set or an array of extras to set
     ...
     *
     * @param StringHelper|array $filter Method to filter the value through
     *
     * @return self
     * @throws InvalidArgumentException
     */
     ...
     *
     * @param StringHelper $name Name of the property to retrieve
     *
     ...
     *
     * @param StringHelper $name Name of the property to remove
     *
     * @return self
     */
     ...
     *
     * @param StringHelper|null $instanceOf Class or interface name
     *
     * @return self
     */
     ...
     *
     * @param StringHelper $pattern Regex pattern
     *
     * @return self
     */
     ...
     *
     * @param StringHelper $format Format to set (e.g. date, date-time, timestamp, time, date-time-http)
     *
     * @return self
     */
