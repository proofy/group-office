...
class SchemaFormatter
{
     ...
     *
     * @param StringHelper $format Registered format used to format the value
     ...
     *
     * @param StringHelper|integer|\DateTime $value Date time value
     *
     * @return StringHelper
     */
     ...
     *
     * @param StringHelper|integer|bool $value Value to convert to a boolean 'true' / 'false' value
     *
     * @return StringHelper
     */
     ...
     *
     * @param StringHelper|integer|\DateTime $value Time value
     *
     * @return int
     */
     ...
     *
     * @param int|StringHelper|\DateTime $dateTime Date time value
     * @param StringHelper               $format   Format of the result
     *
     * @return StringHelper
