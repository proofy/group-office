...
class ServiceDescription implements ServiceDescriptionInterface, ToArrayInterface
{
    ...
    /** @var StringHelper Name of the API */
    protected $name;

    /** @var StringHelper API version */
    protected $apiVersion;

    /** @var StringHelper Summary of the API */
    ...
    /** @var StringHelper baseUrl/basePath */
    protected $baseUrl;

    /**
     * {@inheritdoc}
     * @param StringHelper|array $config  File to build or array of operation information
     ...
     *
     * @param StringHelper $baseUrl Base URL of each operation
     *
     * @return self
     */
