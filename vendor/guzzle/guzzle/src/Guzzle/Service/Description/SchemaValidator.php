...
class SchemaValidator implements ValidatorInterface
{
     ...
     * @param StringHelper    $path   Current validation path (used for error reporting)
     ...
     *
     * @param StringHelper $type  Parameter type
     * @param mixed  $value Value to determine the type
     *
     * @return StringHelper|bool Returns the matching type on
     */
