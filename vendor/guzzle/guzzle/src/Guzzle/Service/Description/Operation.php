...
class Operation implements OperationInterface
{
    ...
    /** @var StringHelper Name of the command */
    protected $name;

    /** @var StringHelper HTTP method */
    protected $httpMethod;

    /** @var StringHelper This is a short summary of what the operation does */
    protected $summary;

    /** @var StringHelper A longer text field to explain the behavior of the operation. */
    protected $notes;

    /** @var StringHelper Reference URL providing more information about the operation */
    protected $documentationUrl;

    /** @var StringHelper HTTP URI of the command */
    protected $uri;

    /** @var StringHelper Class of the command object */
    protected $class;

    /** @var StringHelper This is what is returned from the method */
    protected $responseClass;

    /** @var StringHelper Type information about the response */
    protected $responseType;

    /** @var StringHelper Information about the response returned by the operation */
     ...
     *
     * @param StringHelper $name Name of the parameter to remove
     *
     * @return self
     */
     ...
     *
     * @param StringHelper $httpMethod Method to set
     *
     * @return self
     */
     ...
     *
     * @param StringHelper $className Concrete class name
     *
     * @return self
     */
     ...
     *
     * @param StringHelper $summary Short summary of the operation
     *
     * @return self
     */
     ...
     *
     * @param StringHelper $notes Notes on the operation
     *
     * @return self
     */
     ...
     *
     * @param StringHelper $docUrl Documentation URL
     *
     * @return self
     */
     ...
     *
     * @param StringHelper $responseClass Type of response
     *
     * @return self
     */
     ...
     *
     * @param StringHelper $responseType Response type information
     *
     * @return self
     ...
     *
     * @param StringHelper $notes Response notes
     *
     * @return self
     */
     ...
     *
     * @param StringHelper $uri URI template to set
     *
     * @return self
     */
     ...
     *
     * @param StringHelper $code   HTTP response code
     * @param StringHelper $reason HTTP response reason phrase or information about the error
     * @param StringHelper $class  Exception class associated with the error
     *
     * @return self
     */
     ...
     *
     * @param StringHelper $name  Name of the data value
