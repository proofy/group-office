...
class CompositeFactory implements \IteratorAggregate, \Countable, FactoryInterface
{
     ...
     * @param StringHelper|FactoryInterface $before  Insert the new command factory before a command factory class or object
     ...
     *
     * @param FactoryInterface|StringHelper $factory Factory to check
     *
     * @return bool
     */
     ...
     *
     * @param StringHelper|FactoryInterface $factory Factory to remove by name or instance
     *
     * @return CompositeFactory
     */
     ...
     *
     * @param StringHelper|FactoryInterface $factory Command factory class or instance
     *
