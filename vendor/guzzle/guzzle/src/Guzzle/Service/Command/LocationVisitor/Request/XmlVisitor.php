...
class XmlVisitor extends AbstractRequestVisitor
{
     ...
     *
     * @param StringHelper $header Header to set when XML is found
     *
     * @return self
     */
     ...
     * @param  StringHelper     $prefix    Namespace prefix if any
     * @param  StringHelper     $name      Attribute name
     * @param  StringHelper     $namespace The uri of the namespace
     * @param  StringHelper     $value     The attribute content
     */
     ...
     * @param  StringHelper     $prefix    Namespace prefix if any
     * @param  StringHelper     $name      Element name
     * @param  StringHelper     $namespace The uri of the namespace
     * @param  StringHelper     $value     The element content
     */
     ...
     *
     * @param  StringHelper $encoding document encoding
     *
