...
abstract class ResourceIterator extends AbstractHasDispatcher implements ResourceIteratorInterface
{
    ...
    /** @var StringHelper NextToken/Marker for a subsequent request */
     ...
     *
     * @param StringHelper $key Key of the option to retrieve
     *
     ...
     *
     * @param StringHelper $key   Key of the option to set
     ...
     *
     * @return StringHelper Returns a NextToken
     */
