...
class ServiceBuilder extends AbstractHasDispatcher implements ServiceBuilderInterface, \ArrayAccess, \Serializable
{
     ...
     *
     * @param array|StringHelper $config           The full path to an .json|.js or .php file, or an associative array
     ...
     *
     * @param StringHelper $name Name of the service to retrieve
     *
     * @return array|null
     */
