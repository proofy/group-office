...
abstract class AbstractConfigLoader implements ConfigLoaderInterface
{
     ...
     *
     * @param StringHelper $filename Filename to alias (e.g. _foo)
     * @param StringHelper $alias    Actual file to use (e.g. /path/to/foo.json)
     *
     * @return self
     */
     ...
     *
     * @param StringHelper $alias Alias to remove
     *
     * @return self
     */
     ...
     *
     * @param StringHelper $filename File to load
     *
     * @return array
     ...
     * @param StringHelper $basePath Base path to use when a relative path is encountered
     *
