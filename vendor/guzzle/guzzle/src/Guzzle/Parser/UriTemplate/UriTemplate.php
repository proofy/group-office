...
class UriTemplate implements UriTemplateInterface
{
    ...
    /** @var StringHelper URI template */
    private $template;

    /** @var array Variables to use in the template expansion */
    private $variables;

    /** @var StringHelper Regex used to parse expressions */
     ...
     *
     * @param StringHelper $regexPattern
     */
     ...
     *
     * @param StringHelper $expression Expression to parse
     *
     ...
     *
     * @return StringHelper Returns the replacement string
     */
     ...
     *
     * @param StringHelper $string String to fix
     *
     * @return StringHelper
     */
