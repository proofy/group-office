...
interface CookieParserInterface
{
     ...
     *
     * @param StringHelper $cookie Cookie header value to parse
     * @param StringHelper $host   Host of an associated request
     * @param StringHelper $path   Path of an associated request
