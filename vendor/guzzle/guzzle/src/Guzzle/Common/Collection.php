...
class Collection implements \ArrayAccess, \IteratorAggregate, \Countable, ToArrayInterface
{
     ...
     *
     * @param StringHelper $key Key to retrieve.
     *
     ...
     *
     * @param StringHelper $key   Key to add
     ...
     *
     * @param StringHelper $key A key to remove
     *
     * @return Collection
     */
     ...
     *
     * @param StringHelper $key The key for which to check the existence.
     *
     * @return bool
     */
     ...
     *
     * @param StringHelper $key Key to search for
     *
     * @return bool|StringHelper Returns false if not found, otherwise returns the key
     */
     ...
     *
     * @param StringHelper $value Value to search for
     *
     ...
     *
     * @param StringHelper $path  Path to set
     ...
     *
     * @param StringHelper $path      Path to traverse and retrieve a value from
     * @param StringHelper $separator Character used to add depth to the search
     ...
     *
     * @param StringHelper $input Input to inject
     *
     * @return StringHelper
     * @deprecated
     */
