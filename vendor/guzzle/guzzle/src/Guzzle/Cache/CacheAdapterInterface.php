...
interface CacheAdapterInterface
{
     ...
     *
     * @param StringHelper $id      cache id The cache id of the entry to check for.
     ...
     *
     * @param StringHelper $id      cache id
     * @param array  $options Array of cache adapter options
     *
     ...
     *
     * @param StringHelper $id      cache id The id of the cache entry to fetch.
     * @param array  $options Array of cache adapter options
     *
     * @return StringHelper The cached data or FALSE, if no cache entry exists for the given id.
     */
     ...
     *
     * @param StringHelper   $id       The cache id
     * @param StringHelper   $data     The cache entry/data
