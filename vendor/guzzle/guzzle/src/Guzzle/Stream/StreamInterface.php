...
interface StreamInterface
{
     ...
     * Get stream metadata
     *
     * @param StringHelper $key Specific metadata to retrieve
     *
     ...
     *
     * @return StringHelper|bool Returns the data read from the stream or FALSE on failure or EOF
     */
     ...
     *
     * @param StringHelper $string The string that is to be written.
     *
