...
abstract class GuzzleTestCase extends \PHPUnit_Framework_TestCase
{
     ...
     *
     * @param StringHelper $path Path to mock response folder
     *
     ...
     *
     * @param StringHelper $path Relative path to the mock response file
     *
     * @return Response
     */
     ...
     * @param StringHelper $paths  Path to files within the Mock folder of the service
     *
     ...
     *
     * @param StringHelper $needle Search string
     * @param StringHelper $haystack Search this
     * @param StringHelper $message Optional failure message
     */
